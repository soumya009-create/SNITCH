...
const Login = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault()
        setLoading(true)
        await LoginUser({ email, password }).then((loggedInUser: any) => {
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 font-sans">
            <div className="max-w-md w-full">
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="mt-6 text-3xl font-bold text-gray-900 tracking-tight">Sign in to your account</h2>
                    {check ? (
                        <p className="mt-2 text-sm text-gray-600">Welcome back to Snitch</p>
                    ) : (
                        <p className="mt-2 text-sm text-red-600 font-medium">Invalid email or password</p>
                    )}
                </div>

                <div className="bg-white rounded-2xl shadow-sm ring-1 ring-gray-900/5 px-8 pt-10 pb-8 sm:px-10">
                ...
                <p className="mt-8 text-center text-sm text-gray-500">
                    Not a member?{' '}
                    <Link to="/" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 transition-colors">
                        Create an account
                    </Link>
                </p>
            </div>
